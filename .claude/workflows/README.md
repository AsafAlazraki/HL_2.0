...
THE ORDER, and everything is BUILT before anything is judged: hl2-m2-close → hl2-northside → hl2-paper (Phase 0 of the proposal, the Paper step) → hl2-imagery → hl2-m3 → hl2-m4 → hl2-m5 (revised by the proposal analysis in docs/research/proposal/) → hl2-beauty → hl2-host → hl2-acceptance.
