export const meta = {
  name: 'hl2-beauty',
  description:
    'The beauty and usability sweep: nine lenses over every screen at every size, a clueless-user walk, synthesis, per-screen polish, and the final gate',
  phases: [
    {
      title: 'Shots',
      detail:
    ...
    { title: 'Judge', detail: 'nine independent lenses over the whole app' },
    {
      title: 'Synthesis',
      detail: 'one editor turns nine reports into a ranked, deduplicated work list',
    },
    {
      title: 'Polish',
      detail:
...
Then judge the CRAFT DETAILS that separate good from excellent: the favicon and the tab title, what a print looks like (the paper lens judges the PDF itself; you judge the moment of printing and saving), what the app does at an absurd width, the selection colour, the focus ring, the scrollbars, the cursor over every kind of thing, what is copied when a person selects a row, the transitions the owner will try twice.
