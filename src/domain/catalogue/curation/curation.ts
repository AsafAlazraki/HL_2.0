/* ============================================================
   ...
   The discontinued contract (`@/domain/catalogue/views/sellable`) already
...
import { plural, singular } from '@/domain/catalogue/views/describe'
import { stillOnTheSheet, withheldClause } from '@/domain/catalogue/views/sellable'
 ...
 * `RULE_LEDGER` in `@/domain/rules/constraints/ruleLedger`, whose every
