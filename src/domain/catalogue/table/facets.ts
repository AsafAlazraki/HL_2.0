...
import { leadingNumber, type ViewRow } from '@/domain/catalogue/table/core'
import {
  bandOf,
  isMoney,
  normColumn,
...
export interface BandFacet {
  ...
  label: string
  unit?: string
  /** money prints as money — `@/domain/money`, the format the quote uses */
  money: boolean
  lo: number
  hi: number
}
 ...
 */
export function readFacets(entity: EntityDef | undefined, rows: readonly ViewRow[]): Facet[] {
