...
import { DISCONTINUED_FIELD_ID } from '@/domain/model'
import type { EntityDef, RowData } from '@/domain/model'
import { gapsIn, jobsFor, tableSay } from './jobs'

const ISO = '2026-01-01T00:00:00.000Z'
/* Every persisted record carries its tenant now: `orgId` is required
   on EntityDef and on RowData, so the two builders below stamp one. */
const ORG = 'org-a'
