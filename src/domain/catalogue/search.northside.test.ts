...
/* THE PACK, NOT `buildNorthsideProject()`. The seed is a set of JSON
   ...
   the only reason these four names are filled in `beforeAll` instead
   of at the top of the file. The queries and every assertion below
   are the ones written against the seed this pack was packed from. */
