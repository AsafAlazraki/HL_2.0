/* ============================================================
   ...
   whole point of it — `src/domain/rules/adopt.ts` explains why a
   ...
   `src/domain/rules/configure` propagates ONE partial configuration and
   reports its warnings on `SolveState.warned`. This file is the
   other engine's half of the same idea: `@/domain/rules/engine` walks rows and
...
import { readCell, type ClauseGroup, type ConstraintDef } from '@/domain/model'
import type { RowRef, RuleEngine } from '@/domain/rules/engine/evaluate'
