/* ============================================================
   ...
   NOT, on purpose:
     ...
     · `@/domain/catalogue/views/filter.ts` skips an empty `values` filter, so
     ...
     · `@/domain/catalogue/table/core/view.ts` admits NOTHING through an empty
...
import type { CellValue, ColumnFilter, EntityDef, FieldDef, RowData } from '@/domain/model'
import { applyView } from '@/domain/catalogue/table/core'
