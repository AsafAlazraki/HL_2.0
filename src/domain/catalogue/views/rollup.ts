/* ============================================================
   ...
   @/domain/quote/pricing is the only resolver in this app, and
   ...
   `@/domain/quote/pricing` imports `@/domain/model`, `@/domain/money`
   ...
   move `QuoteEditor` makes with `@/domain/catalogue/views/sellable`.
   ============================================================ */

import { rowLabel, type EntityDef, type RowData, type ViewDef } from '@/domain/model'
import type { RuleEngine } from '@/domain/rules/engine/evaluate'
