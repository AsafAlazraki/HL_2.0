/* ============================================================
   ...
   `@/domain/model` gives this feature two questions and both are
...
export const sellableRows = (rows: RowData[]): RowData[] => rows.filter((r) => !isDiscontinued(r))
 ...
 *  back — and `@/domain/catalogue/curation` prints them as one paragraph. It
