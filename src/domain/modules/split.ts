...
import { TABLE_KINDS, type EntityDef, type ModuleDef, type TableKind } from '@/domain/model'
...
export function splitReading(module: ModuleDef, entities: Record<string, EntityDef>): SplitReading {
