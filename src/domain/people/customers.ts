...
export function customerRegister(entities: Record<string, EntityDef>): EntityDef | undefined {
...
export function readCustomers(entity: EntityDef, rows: readonly RowData[]): CustomerRead[] {
