/* ============================================================
   ...
   `src/domain/rules/configure` records AT THE MOMENT OF REMOVAL — that is
...
import type { CellValue } from '@/domain/model'
import { formatValue } from '@/domain/rules/configure'
...
export type BlockedLookup = (fieldId: string, value: CellValue) => { because: string } | undefined
