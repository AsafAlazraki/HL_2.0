...
import type { CellValue, ColumnSection, EntityDef, FieldDef, TableKind } from '@/domain/model'
 ...
 */
export function quoteLevelChoices(lines: Array<{ levels: FrozenLevel[] }>): QuoteLevelChoice[] {
 ...
 *
 *  It lives in `@/domain/money` now, because a spec block on an item page
