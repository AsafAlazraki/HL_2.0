/* ============================================================
   ...
   `src/domain/rules/configure` has been able to answer this since it was
...
import { formatValue, isBlank, optionsOf, solve, valueKey } from '@/domain/rules/configure'
...
import { constraintsFor, moduleKinds, workbookRulesFor } from '@/domain/modules/moduleRules'
 ...
 */
export function subjectVerdict(place: PlaceRules, entity: EntityDef, row: RowData): SubjectVerdict {
