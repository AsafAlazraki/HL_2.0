...
/* The seed is the pack now — the same 53 tables, read off the generated
   JSON once per worker instead of out of a TypeScript literal. */
...
function project(): {
  ...
  return { entities, rowsByEntity: pack.rowsByEntity }
}
