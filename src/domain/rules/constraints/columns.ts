...
import { TABLE_KINDS, isPairFieldId, readCell } from '@/domain/model'
import type { CellValue, EntityDef, FieldDef, FieldType, RowData, TableKind } from '@/domain/model'
...
export function fieldOn(concept: ColumnConcept, table: EntityDef): FieldDef | undefined {
...
export const isUnsetValue = (v: CellValue): boolean => v === null || v === undefined || v === ''
