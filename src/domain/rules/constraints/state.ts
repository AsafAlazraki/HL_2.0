...
import { compareValues, isEmptyValue } from '@/domain/rules/engine'
import { countLabel, kindNoun, leafNoun, type LeafNoun } from '@/domain/catalogue/table/grouping'
import type { ColumnConcept } from './columns'
import type { CellValue, Clause, ClauseGroup, ConstraintDef, EntityDef } from '@/domain/model'
...
const COLUMN_GONE =
  'One column this rule names has been deleted. Point it at a column that is still there.'
...
function gapIn(group: ClauseGroup | undefined, side: Side, ctx: SentenceCtx): MissingSlot | null {
