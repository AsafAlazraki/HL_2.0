...
import type { CellValue, FieldDef } from '@/domain/model'
...
export const isEnumerable = (field: FieldDef | undefined): boolean => optionsOf(field) !== undefined
...
export const isUnknown = (d: FieldDomain | undefined): boolean => !d || d.values.length === 0
