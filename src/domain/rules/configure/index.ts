/* ============================================================
   The configurator's constraint solver — public surface.
     ...
     import { solve, explain, describeChange } from '@/domain/rules/configure'
     import type { ConfigureInput } from '@/domain/rules/configure'
   ...
   That is NOT the question '@/domain/rules/engine' answers. That engine walks
   ...
   import is '@/domain/model'. Nothing here throws, for any input —
   ...
   ConfigureState is defined in '@/domain/model' and is returned exactly
