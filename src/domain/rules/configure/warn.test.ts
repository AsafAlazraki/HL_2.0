...
import type { ConstraintDef, FieldDef } from '@/domain/model'
      ...
      clauses: [
        {
          ...
          left: { fieldId: 'hull' },
          op: 'eq',
          right: { kind: 'literal', value: 'small' },
        },
      ],
    },
    then: {
      combinator: 'AND',
      clauses: [
        { id: 'k2', left: { fieldId: 'motor' }, op: 'eq', right: { kind: 'literal', value: '90' } },
      ],
    },
    ...(severity ? { severity } : {}),
  })
      ...
      constraints: [
        rule({
          ...
          if: {
            combinator: 'AND',
            clauses: [
              { id: 'p', left: { fieldId: 'a' }, op: 'eq', right: { kind: 'literal', value: '1' } },
            ],
          },
          then: {
            combinator: 'AND',
            clauses: [
              { id: 'q', left: { fieldId: 'b' }, op: 'eq', right: { kind: 'literal', value: '1' } },
            ],
          },
        }),
      ],
