...
import { asBoolean, asNumber, asText, finite, stringify, FN_IMPLS } from './functions'
...
function evalBinary(op: string, leftExpr: Expr, rightExpr: Expr, env: EvalEnv): CellValue {
