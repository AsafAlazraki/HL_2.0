...
export type Expr = NumExpr | StrExpr | BoolExpr | FieldExpr | UnaryExpr | BinaryExpr | CallExpr
...
export function walkFieldRefs(expr: Expr, visit: (name: string, pos: number) => void): void {
  switch (expr.kind) {
    case 'num':
    case 'str':
    case 'bool':
