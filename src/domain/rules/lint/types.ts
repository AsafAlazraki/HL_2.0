/* ============================================================
   ...
   Owned by src/domain/rules/lint. Pure types; no runtime dependencies
...
export interface LintFinding {
  ...
  entityId: string
  fieldIds?: string[]
  /** short mark label, mono-uppercase-able, e.g. 'PLURAL TABLE NAME' */
  title: string
...
/** Input shape for lintProject — the two maps `CatalogueCtx` carries. */
