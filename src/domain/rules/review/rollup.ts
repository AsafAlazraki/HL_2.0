...
import type { AccentKey, EntityDef } from '@/domain/model'
import type { FindingSeverity, LintFinding } from '@/domain/rules/lint'
 ...
 */
export function resolveOpenRule(ledger: readonly RuleRow[], picked: string | null): string | null {
...
export function buildGroups(
  ...
  for (const g of map.values()) {
    g.rolls.sort((a, b) => SEV_RANK[a.severity] - SEV_RANK[b.severity] || cmp(a.ruleId, b.ruleId))
  }
