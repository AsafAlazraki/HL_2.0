/* ============================================================
   ...
   Owned by src/domain/rules/engine. Pure types; the only dependency is
   the domain model. No React, no store, no DOM, no Dexie.
   ============================================================ */

import type { CellValue, EntityDef, RowData, ViewColumn } from '@/domain/model'

/* ---------------------------------------------------------- */
/* Input                                                      */
/* ---------------------------------------------------------- */

/** Everything a run reads. The same two maps `CatalogueCtx` carries;
