...
/* ============================================================
   ...
   WHICH IS PRECISELY WHY IT IS A MODULE NOW. "Fails only if it
   measured nothing" is a weak assertion to hang a report on: it passes
   on a run that read one token out of forty. `fixture.spec.ts` gives
   it a page whose tokens are known, declared inside a grouping rule,
   and checks the figures it reports against them.
   ============================================================ */
